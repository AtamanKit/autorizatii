...
class CorectDs extends React.Component {
    state = {
        oficii_items: [],
        // cu_dec_items: [],
        angaj_items: [],
    ...
    componentDidMount() {
        this.setState({dsAl_num: document.location.pathname.slice(-4)})
    ...
    EmInput = evt => {
        document.getElementById("em_input").innerText = myCookies[1] +" gr. 5"
    }
    ...
    render() {
        ...
        return ( 
            <React.Fragment>
                ...
                <h1 className="bir_disp">CORECTATI DISPOZITIE</h1>
                <Form className="form-inreg">
                    ...
                    />
                    {/* {!this.state.al_link_cookie
                    ? <p className="no-pass">Nu este introdusa destinatia AL/DS. Obtiunea link nu va functiona!</p>
                    : ""
                    } */}
                    {
